...
Datasheet$`Site Name`[Datasheet$`Site Name` %in% c("Cerro Toledo", "El Tiro\n" , "Laguna Natosas forest", "Pedras Blancas","Huila", "Paramo de Agua Blanca III", "Paramo de pena Negra I"   )]<-c("Cerro Toledo CT", "El Tiro", "Lagunas Natosas Forest", "Piedras Blancas", "Huila\n", "Agua Blanca PAB III", "Paramo de Pena Negra 1")
#Repeat (1)
